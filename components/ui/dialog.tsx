  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 text-zinc-500 opacity-80 transition hover:bg-zinc-100 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-zinc-300 disabled:pointer-events-none">
            <X className="size-5" />
